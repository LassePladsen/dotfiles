...
" Attempt to fix kitty and modern terminal features
" https://sw.kovidgoyal.net/kitty/faq/#i-get-errors-about-the-terminal-being-unknown-or-opening-the-terminal-failing-when-sshing-into-a-different-computerjj
" Mouse support
set ttymouse=sgr
set balloonevalterm
